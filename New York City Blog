  ...
  <body> 
    <nav>
     ...
     <main>
       ...
       <figure> <img src ="https://content.codecademy.com/courses/Semantic%20HTML/statue-of-liberty.jpeg" <figcaption> " This is the Statue of Liberty, a popular tourist attraction located on Liberty Island".
       </figure>
...
<p>While the view in the city is beautiful, the sounds are not as lovely. Below you'll see an example of the view and the sounds you'll deal with in NYC on a daily basis.</p>
 ...
 <audio src = "https://content.codecademy.com/courses/Semantic%20HTML/nyc-sounds.mov" controls> </audio>
    ...
    <footer> <p> Posted by Alberto Orduña</p>
    <p> ordunafalberto@gmail.com</p>
     </footer>
  </body>
</html>
